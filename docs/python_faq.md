...
- What is meant by selection, iteration and sequence controlstructures?
## Sequence:
...
- Write any two disadvantages of
flowchart ?
 It is not visual
...
- What are the rules for writing pseudo
code?
 Write one statement
 per line. Capitalize
 initial keywords.
...
## 1.
It is a well-defined procedure that It is a simple way of writing programming code
allows a computer to solve a problem. in English.

- Algorithms   can   be   described   in Pseudo   code   describes   how   you   would
...
## 1.
Step by Step formation  Box by box formation
...
## 3.
More   detailed  but difficult to Lessdetailed but easyto understand
understand
...
- List the standard data types in
python.
...
- Ilustrate interpreter and interactive mode in python
with example. 3.Explain function and module with
suitable example

- Write short notes on types of operators in python with appropriate example

- Explain briefly constant, variables, expression, keywords and
...
[ ̳Problem‘,  ̳Solving‘,  ̳and‘,  ̳Python‘,  ̳Programing‘]
## PART B
...
- What is the output of print tuple[1:3] if tuple = ( 'abcd', 786 , 2.23, 'john', 70.2 )? In the
...
The standard comparisons ( ̳<‘,‘>‘,‘<=‘,‘>=‘,‘==‘) work exactly the
...
## 
- What is the output of print tuple + tinytuple if tuple = ( 'abcd', 786 , 2.23, 'john', 70.2 )
...
- What is meant by invocation? Where is it used and how?
...
- Explain values and items method used in dictionary with example.
...
- What is the difference between modify and copy operations performed in
...
>>> print f<open file  ̳test.dat‘, mode  ̳w‘ at fe820> The open function takes two
...
- What is meant by directory? How and where is it useful?
