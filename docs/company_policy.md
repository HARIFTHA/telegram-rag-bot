...
Process  of  Recruitment: Candidate  will  be  searched  based  upon  the  project  assigned  to  the
...
the  cadre  of  the  students.  The  company  can  hire  the  students  to  give  the  right  path  and
...
Internships  Programme: The  Company  can  hire  the  students  from  the  Reputed  Colleges
...
The  Department  Heads  will  inform  the  HR  Department  in  advance  regarding  the  hiring  of  the
...
proper  pay  structure  will  be  given  to  the  students  with  the  slab  of  Rs  250000  to  350000  per
...
a) Sirca  is  the  career  and  long  term  orientation  and  commitment  to  guide  and  develop  the
...
number of the employee attend that particular training during the year and based upon that
...
bondwill be signed by the employee and the duration of the training bond will be decided by
the Management.
...
k) On  extreme  emergency,  the  employee  will  inform  the  leave  to  the  Reporting  Officer  or  HR
...
Every  Employee  will  take  the  approval  or  provide  the  information  to  their  Reporting  Officer
...
employee.  The  same  will be  arranged  by  the  Administration  Department  or  by  the  employee
...
lapsed after  the month. For  Example:  If  the  employee  will  work  on  26
th
Aug,  then  the
employee can avail the compensatory leave till 25
th
Sept, not beyond than that.
...
e) Relocation  Grant  will  be  given  when  the employee and  his  family  will  be  transfer from one
...
the services. Exit Interview will directly submit to the HR Department either in the form of
...
of  email  id and  submission  of  Laptop/Desktop), Administration  (for  submission  of  mobile
...
communication  that  expresses dissatisfaction  about  an  action  or  lack  of  action,  about  the
standard of service.
...
For  the  above,  Employee  Counseling  plays  an  important  role  in  the  grievances  and acts  as  a
...
Marriage  is  the  blissful  loop  of  the  sweet  memories,  and  to  make  happiness  with  the  partners,
...
A  wedding  is  the  ceremony  where  two  people  are  united  in  marriage.  Wedding  traditions  and
...
Class V: Rs  2500/- will  be  given  as  a  CASH  REWARD,  if  the  child  will
...
Class XII: Rs  10000/- will  be  given  as  a  CASH  REWARD,  if  the  child  will
secured the marks above 80%
...
leave  the  employee  has  to  submit  the  photocopy  of  the  report  and  when  rejoined  the  Medical
...
report  and  the  proper  review  from  the  respective  department will  be  taken.  Based  upon  the
...
of  daily  business activities.  The  purpose  of attendance  is  to  provide  the  clarity  to all  employees
...
order  to  complete  the  certain  assignments  on  time,  they  would  be  reimbursed  meal  expenses
...
While  working  on  the  weekends  or public  holiday,  the  employee  have  to  take  the approval  from
...
## 2
Assistant Vice Presidents/Zonal Sales Manager/
General Manager/CFO/CS
## GC 2
## 3
Head/Regional Sales Manager/Deputy General
## Manager
## GC 3
## 4
Sr Manager/Sr Area Sales Manager/Assistant General
## Manager
## GC 4
...
This will be evaluated on yearly basis and the award will be awarded by Managing Directors. The
